...
window.CabinetChassis = (function () {
  ...
  const CHASSIS_CATALOG = [
    ...
    { code: 'Chassis-LISA-PATCH-2U',   label: 'LISA PATCH 2U',  desc: 'LISA patch chassis, 2U',    heightU: 2 },
    { code: 'Chassis-LISA-PATCH-3U',   label: 'LISA PATCH 3U',  desc: 'LISA patch chassis, 3U',    heightU: 3 },
    { code: 'Chassis-LISA-PATCH-6U',   label: 'LISA PATCH 6U',  desc: 'LISA patch chassis, 6U',    heightU: 6 },
    { code: 'Chassis-LISA-PATCH-7U',   label: 'LISA PATCH 7U',  desc: 'LISA patch chassis, 7U',    heightU: 7 },
